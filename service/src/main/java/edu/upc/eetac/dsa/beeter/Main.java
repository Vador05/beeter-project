...
public class Main {
    ...
    /**
     * public static final String BASE_URI; = "http://localhost:8080/myapp/";  De momento no definiremios el puerto.
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.in.read();
        /**server.stop(); Descartamos este comando porque esta obsoleto*/
        server.shutdownNow();
    }
}
